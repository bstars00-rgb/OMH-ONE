...
export const forms: MessageTable = {
  ...
  'picker.placeholder': { en: 'Search by name, team or title…', ko: '이름, 부서, 직위로 검색…' },
  'picker.noMatch': { en: 'Nobody matches “{query}”.', ko: '“{query}”에 해당하는 사람이 없습니다.' },
  'picker.clear': { en: 'Clear {name}', ko: '{name} 선택 해제' },
  'chain.line': { en: 'Approval line', ko: '결재라인' },
  'chain.autoLine': { en: 'Automatic — from the org chart', ko: '자동 — 조직도 기준' },
  'chain.myLines': { en: 'My lines', ko: 'My결재라인' },
  'chain.orgLines': { en: 'Shared lines', ko: '결재라인' },
  'chain.approvers': { en: 'Approvers', ko: '결재자' },
  'chain.edited': { en: 'Edited', ko: '수정됨' },
  'chain.empty': { en: 'No approver yet. Pick a line or add someone.', ko: '결재자가 없습니다. 결재라인을 고르거나 직접 추가하세요.' },
  'chain.moveUp': { en: 'Move approver {n} earlier', ko: '결재자 {n} 앞으로' },
  'chain.moveDown': { en: 'Move approver {n} later', ko: '결재자 {n} 뒤로' },
  'chain.reset': { en: 'Back to automatic', ko: '자동으로 되돌리기' },
  'chain.saveAsMine': { en: 'Save as my line', ko: 'My결재라인으로 저장' },
  'chain.myLineName': { en: 'Name this line, e.g. 휴가계_SCM', ko: '결재라인 이름, 예: 휴가계_SCM' },
  'chain.saved': { en: '{name} saved to your lines.', ko: '{name} — My결재라인에 저장했습니다.' },
  'chain.needName': { en: 'Give the line a name.', ko: '결재라인 이름을 입력하세요.' },
  'chain.needApprover': { en: 'A line needs at least one approver.', ko: '결재라인에는 결재자가 최소 1명 필요합니다.' },
  'chain.lineNotFound': { en: 'That line is not yours to change.', ko: '수정 권한이 없는 결재라인입니다.' },
  'chain.lineDeleted': { en: '{name} removed.', ko: '{name} 삭제했습니다.' },
  ...
  'chain.note': {
    en: 'Edit freely — add, remove or reorder. A route that differs from the suggestion is marked on the request so approvers and auditors can see it.',
    ko: '추가·삭제·순서변경 모두 가능합니다. 제안된 결재선과 다르면 기안에 표시되어 결재자와 감사가 확인할 수 있습니다.',
  },
